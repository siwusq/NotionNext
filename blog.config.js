...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'siwusongqi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个现实的理想主义者，在自己的颅内刻入生命的褶皱', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://siwuwebsite.vercel.app/', // 网站地址
